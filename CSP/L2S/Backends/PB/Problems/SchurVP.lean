...
The Schur CSP `schur_csp 5 2` extended with the full Law–Lee `value_precedence 2` constraint.
...
def schur_2_5_vp : IntCSP := (Schur.schur_csp 5 2).addConstraint (value_precedence 2)
...
def schur_3_14_vp : IntCSP := (Schur.schur_csp 14 3).addConstraint (value_precedence 3)
