...
(assert (= x15 (and x0 x1)))
(assert (= x16 (and x15 x2)))
(assert (= x17 (and x16 x3)))
(assert (= x18 (and x17 x4)))
(assert (= x19 (and x18 x5)))
(assert (= x20 (and x19 x6)))
(assert (= x21 (and x7 x8)))
(assert (= x22 (and x21 x9)))
(assert (= x23 (and x22 x10)))
(assert (= x24 (and x23 x11)))
(assert (= x25 (and x24 x12)))
(assert (= x26 (and x25 x13)))
(assert (= x27 (and x26 x14)))
(assert (= x28 (or x20 x27)))
