...
(assert (= x30 (not x14)))
(assert (= x31 (not x15)))
(assert (= x32 (or x16 x17)))
(assert (= x33 (or x18 x19)))
(assert (= x34 (or x20 x21)))
(assert (= x35 (or x22 x23)))
(assert (= x36 (or x24 x25)))
(assert (= x37 (or x26 x27)))
(assert (= x38 (or x28 x29)))
(assert (= x39 (or x30 x31)))
(assert (= x40 (or x32 x33)))
(assert (= x41 (or x34 x35)))
(assert (= x42 (or x36 x37)))
(assert (= x43 (or x38 x39)))
(assert (= x44 (or x40 x41)))
(assert (= x45 (or x42 x43)))
(assert (= x46 (or x44 x45)))
