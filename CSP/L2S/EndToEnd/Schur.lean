...
2. **Verified PB UNSAT** (`Problems/SchurSBC.lean`): the *extended* CSP
   `(schur_sb 5 2).addConstraint (x₀ = 0)` is UNSAT, certified by a kernel-checked
...
theorem schur_2_5_unsat : ¬ (_root_.Schur.schur_sb 5 2).isSatisfiableInt :=
  unsat_of_sbc _ _
    (_root_.Schur.schur_sb_is_symmetry_breaking 5 2 (by decide) (by decide)
      (_root_.Schur.schurTriples 5))
    PB.SchurSBC.extended_schur_2_5_unsat
...
theorem schur_3_14_unsat : ¬ (_root_.Schur.schur_sb 14 3).isSatisfiableInt :=
  unsat_of_sbc _ _
