...
theorem php_3_2_unsat_via_value_precedence : ¬ (_root_.Pigeonhole.php_sb 3 2).isSatisfiableInt :=
...
theorem php_5_4_unsat_via_value_precedence : ¬ (_root_.Pigeonhole.php_sb 5 4).isSatisfiableInt :=
