> **ARCHIVED — superseded by `PLAN.md`.** This is the original from-scratch
> implementation plan. The backend is now implemented; see `PLAN.md` for the
> as-built status, architecture, results, and how the implementation diverged from
> this plan. This file is kept for its design rationale, dependency notes, and
